...
class PanDataset(data.Dataset):
    def __init__(
        ...
        *,
        ...
        self.pan_hp = norm_func(self.pan_hp)
    ...
    def __getitem__(self, item):
        if hasattr(self, "gt"):
            dict_data = {'pan':self.pan[item], 'ms':self.ms[item], 'lms':self.lms[item], 'gt':self.gt[item]}
        ...
        # return self.aug_trans(dict_data) if self.aug_prob != 0.0 else dict_data
        return dict_data
